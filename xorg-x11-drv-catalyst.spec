...
Source100:	 blacklist-radeon.conf
...
Requires(post):  pyxf86config >= 0.3.37-10
...
/sbin/ldconfig -n $RPM_BUILD_ROOT/%{atilibdir}/
...
install -pm 0644 %{SOURCE100} $RPM_BUILD_ROOT%{_sysconfdir}/modprobe.d/
...
if [ -x /usr/sbin/setsebool ] ; then
    ...
    chcon -t textrel_shlib_t '%{_libdir}/dri/fglrx_dri.so'
    semanage fcontext -a -t textrel_shlib_t '%{_libdir}/dri/fglrx_dri.so'
fi
...
if [ "${1}" -eq 0 ]; then
  ...
  test -f /etc/X11/xorg.conf && rm -f /etc/X11/xorg.conf
...
%changelog
* Tue May 10 2011 Arkady L. Shane <ashejn@yandex-team.ru> - 11.5-1.R
- update to 11.5
...
* Tue Dec 14 2010 Arkady L. Shane <ashejn@yandex-team.ru> - 10.12-3
- fix path to fglrx_dri.so in %%post
- move selinux %%post script to libs package

* Tue Dec 14 2010 Arkady L. Shane <ashejn@yandex-team.ru> - 10.12-2
- remove xorg.conf during uninstall

* Tue Dec 14 2010 Arkady L. Shane <ashejn@yandex-team.ru> - 10.12-1
- update to 10.12 

* Wed Dec  8 2010 Arkady L. Shane <ashejn@yandex-team.ru> - 10.11-3
- added rdblacklist=radeon to grub.conf

* Tue Dec  7 2010 Arkady L. Shane <ashejn@yandex-team.ru> - 10.11-2
- R: pyxf86config >= 0.3.37-10

* Tue Dec  7 2010 Arkady L. Shane <ashejn@yandex-team.ru> - 10.11-1
- return to standart catalyst-config-display
- update to 10.11
- apply some SELinux rules after install

* Fri Oct 29 2010 Leonid Kanter <lkanter@gmail.com> - 10.10-1.1
- Fix library path

* Thu Oct 28 2010 Leonid Kanter <lkanter@gmail.com> - 10.10-1
- Update to Catalyst 10.10 (internal version 8.78.6)
